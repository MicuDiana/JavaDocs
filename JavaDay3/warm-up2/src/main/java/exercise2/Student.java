...
public class Student {
    ...
    public boolean equals(Object o) {
        ...
        if((id.equals(myStud.id)) && (lastName.equals(myStud.lastName) ) && (firstName.equals(myStud.firstName)) && (averageGrade.equals(myStud.averageGrade)))
            return true;
        return false;
    ...
    public int hashCode() {
        ...
        return id.hashCode() + firstName.hashCode() + lastName.hashCode() + averageGrade.hashCode();
